...
\033[1;94m ┈┈┈▕▕SS M4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕SK M4▏▏┈┈┈
...
\033[1;91m☞ Auther     : Subhan_Khan_SUBHAN_OP
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/M4_SUBHAN')
	    ...
	    psb('Subscrib My Youtube Channel Subhan Tricks M4 MASTER✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/M4_SUBHAN && python2 M4_SUBHAN.py')
